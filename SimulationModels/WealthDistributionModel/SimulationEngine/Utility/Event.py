class Event:
    ...
    def __str__(self):
        return "Event : Sender : "+str(self.modelSender.getModelID())+", Port : "+str(self.portSender)+", Resolution Change : "+str(self.blnResolutionChange)+", Message : "+str(self.message)
